                ...
                c = {
                    proxyEvents: function(e) {
                        var t = {},
                            ...
                            i = void 0;
                        try {
                            for (var u, c = o.default[Symbol.iterator](); !(r = (u = c.next()).done); r = !0) {
                                n(u.value)
                            }
                        } catch (s) {
                            a = !0, i = s
        ...
        tkbZ: function(e, t, n) {
            ...
            var S = function(e) {
                ...
                function o(e) {
                    ...
                    }(this, o), m(b(t = a.call(this, e)), "onPlayerReady", (function(e) {
                        return t.props.onReady(e)
                    })), m(b(t), "onPlayerError", (function(e) {
                        return t.props.onError(e)
                    })), m(b(t), "onPlayerStateChange", (function(e) {
                    ...
                    })), m(b(t), "onPlayerPlaybackRateChange", (function(e) {
                        return t.props.onPlaybackRateChange(e)
                    })), m(b(t), "onPlayerPlaybackQualityChange", (function(e) {
                        return t.props.onPlaybackQualityChange(e)
                    })), m(b(t), "createPlayer", (function() {
                        if ("undefined" !== typeof document) {
                            var e = g(g({}, t.props.opts), {}, {
                                videoId: t.props.videoId
                            });
                            t.internalPlayer = s()(t.container, e), t.internalPlayer.on("ready", t.onPlayerReady), t.internalPlayer.on("error", t.onPlayerError), t.internalPlayer.on("stateChange", t.onPlayerStateChange), t.internalPlayer.on("playbackRateChange", t.onPlayerPlaybackRateChange), t.internalPlayer.on("playbackQualityChange", t.onPlayerPlaybackQualityChange)
                        }
                    })), m(b(t), "resetPlayer", (function() {
                        return t.internalPlayer.destroy().then(t.createPlayer)
                    })), m(b(t), "updatePlayer", (function() {
                    ...
                    })), m(b(t), "getInternalPlayer", (function() {
                        return t.internalPlayer
                    })), m(b(t), "updateVideo", (function() {
                        if ("undefined" !== typeof t.props.videoId && null !== t.props.videoId) {
                            var e = !1,
                                n = {
                                    videoId: t.props.videoId
                                };
