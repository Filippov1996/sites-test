            ...
            if(count<=all_slides.length-1){
                       ...
                       if(slide.classList.contains('next-btn')){
                        ...
                        if(slide.classList.contains('last-slide')){
                            console.log("ddd")
                            last_btn =  slide.querySelectorAll(".btn")[0];
                            ...
                            last_btn.addEventListener("click",function(){
                                ...
                                goToPrevSlide.style.display="none";
                                 goToNextSlide.style.display="block";
                                    console.log(count)
                                var items  = document.querySelectorAll(".question-block .item");
                                var points  = document.querySelectorAll(".question-block .item .radio div");
                                var modals = document.querySelectorAll(".question-block .modal-answer");
                                var btns = document.querySelectorAll(".question-block .btn-reply");
                                items.forEach(function(item){
                                    item.classList.remove("ch");
                                    item.classList.remove("true_answer");
                                    item.classList.remove("false_answer");
                                    console.log('yes');
                                });
                                points.forEach(function(item){
                                    item.classList.remove("radio-point");
                                });
